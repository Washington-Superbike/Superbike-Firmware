...
API functions that have the potential to cause a context switch (for example, \mbox{\hyperlink{task_8h_a067da3e949e248096ec6c01f9cb75a47}{v\+Task\+Delay\+Until()}}, \mbox{\hyperlink{queue_8h_af7eb49d3249351176992950d9185abe9}{x\+Queue\+Send()}}, etc.) must not be called while the scheduler is suspended.
