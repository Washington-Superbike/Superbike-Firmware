...
Set bits within an event group. This function cannot be called from an interrupt. \mbox{\hyperlink{event__groups_8h_a62b68278abac6358369ae8e390988a02}{x\+Event\+Group\+Set\+Bits\+From\+ISR()}} is a version that can be called from an interrupt.
