...
{\em px\+Task\+Definition} & Pointer to a structure that contains a member for each of the normal \mbox{\hyperlink{tasks_8c_ad138d9dda4709b10d711775fa40eb1a1}{x\+Task\+Create()}} parameters (see the \mbox{\hyperlink{tasks_8c_ad138d9dda4709b10d711775fa40eb1a1}{x\+Task\+Create()}} API documentation) plus an optional stack buffer and the memory region definitions.\\
\hline
...
TaskHandle\_t xHandle;
    ...
    // Start the scheduler.
    \mbox{\hyperlink{task_8h_aaf9dca1065c60abdeb309d56ab7293cb}{vTaskStartScheduler()}};
...
Memory regions are assigned to a restricted task when the task is created by a call to x\+Task\+Create\+Restricted(). These regions can be redefined using \mbox{\hyperlink{task_8h_ad889595baff9faf9efe02f3696825409}{v\+Task\+Allocate\+MPURegions()}}.
