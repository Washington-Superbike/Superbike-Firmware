...
//          /// TESTING the display updating
//          MeasurementScreenData test = *(displayWrapper.msDataWrap);
//          Serial.printf("%d\n", *(test.mainBatteryVoltage));
//          *test.mainBatteryVoltage = *test.mainBatteryVoltage + 1;
//          Serial.printf("%d\n", *(test.motorControllerVoltage));
//          *test.motorControllerVoltage = *test.motorControllerVoltage + 1;
//          Serial.printf("%d\n", 420);
//          *test.auxiliaryBatteryVoltage = *test.auxiliaryBatteryVoltage + 1;
//          Serial.printf("%d\n", 420);
//          *test.RPM = *test.RPM + 1;
//          Serial.printf("%d\n", 420);
//          *test.motorTemp = *test.motorTemp + 1;
//          Serial.printf("%d\n", 420);
//          *test.motorCurrent = *test.motorCurrent + 1;
//          Serial.printf("%d\n", 420);
//          *test.errorMessage = *test.errorMessage + 1;
//          Serial.printf("%d\n", 420);
//          *test.chargerCurrent = *test.chargerCurrent + 1;
//          Serial.printf("%d\n", 420);
//          *test.chargerVoltage = *test.chargerVoltage + 1;
//          Serial.printf("%d\n", 420);
//          *test.bmsStatusFlag = *test.bmsStatusFlag + 1;
//          Serial.printf("%d\n", 420);
//          *test.evccVoltage = *test.evccVoltage + 1;
//          Serial.printf("%d\n", 420);
//          *test.thermistorTemps = *test.thermistorTemps + 1;
